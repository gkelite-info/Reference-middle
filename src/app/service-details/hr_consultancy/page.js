          ...
          <div className="row gy-0 px-3 px-lg-0">
            ...
            <div className="col-lg-5 h-25 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100">
              <div className="services-list">
                ...
                <Link href="/service-details/hr_consultancy" className="active">Lorem_5</Link>
              </div>
              <h4>Lorem_Ipsum: Strategies for Hiring Top Talent</h4>
              <p>
                At Lorem_Ipsum, we are committed to connecting organizations with the right talent, empowering professionals through training, and delivering end-to-end HR solutions that drive business growth and success.
              </p>
            </div>
