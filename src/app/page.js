          ...
          <div id="hero-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div className="carousel-item active">
              ...
              <div className="container">
                ...
                <p>At Lorem_Ipsum-Info Service, we are dedicated to securing top-tier talent that fuels innovation and business growth. As one of the fastest-growing talent acquisition platforms, we are the preferred recruiting partner for numerous Fortune 500 companies.</p>
            ...
            <div className="carousel-item">
              ...
              <div className="container">
                ...
                <p>Lorem_Ipsum-Info Digital amplifies your brand’s visibility and elevates your online presence to new heights with cutting-edge, results-driven digital marketing strategies!</p>
                <Link href="about.html" className="btn-get-started">Read More</Link>
              </div>
            </div>
            ...
            <div className="carousel-item">
              ...
              <div className="container">
                ...
                <p> Mastering B2B and B2C sales is crucial in today’s competitive marketplace. Lorem_Ipsum-Info specializes in providing unparalleled sales services that enhance your sales strategy and deliver measurable results in both business-to-business and business-to-consumer sectors.</p>
                <Link href="about.html" className="btn-get-started">Read More</Link>
              </div>
            </div>
